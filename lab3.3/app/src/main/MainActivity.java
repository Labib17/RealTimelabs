...
package ua.humeniuk.lab33;
  ...
  public class MainActivity extends AppCompatActivity {
      ...
      protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText mut_chanse = (EditText)findViewById(R.id.it);
          ...
          b1.setOnClickListener(new View.OnClickListener() {
              public void onClick(View v) {
                ...
                int imut_chanse = Integer.parseInt(it.getText().toString());
                  n = 0;
                  mrt = 0;
                  mutationCounter = 0;
                  int[] rs = Genetic(iy,ia,ib,ic,id,iit, imut_chanse);
      ...
      static int[] Genetic(int res,int a, int b,int c,int d, int itr int mut_chanse){
